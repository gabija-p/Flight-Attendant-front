...
export default function AddFlight(){
    ...
    const [Gate, setGate]=useState(localStorage.getItem("gate"));
    ...
    <div className="d-flex justify-content-center">
      <div className="box" style={{width: "40%"}}>
        <header className="header pt-2 mb-5 d-flex justify-content-center" style={{fontFamily:'Roboto', fontWeight:"bold", fontSize:"25px", color:"#4b7377", opacity:60}}>Skrydžio redagavimas</header>
